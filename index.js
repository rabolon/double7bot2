...
async function run() {
  ...
  // shift dataPlot every minute
    ...
    // console.log(`Asset: ${assetQty.toFixed(7)}, Base: ${baseQty.toFixed(2)}, Profit: ${((assetQty - assetQtyInit)* price + (baseQty - baseQtyInit)).toFixed(2)}`);
